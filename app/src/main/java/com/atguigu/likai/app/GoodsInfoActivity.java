...
import com.atguigu.likai.home.bean.GoodsBean;
import com.atguigu.likai.shoppingcart.utils.CartStorage;
import com.atguigu.likai.shoppingcart.view.AddSubView;
import com.atguigu.likai.utils.Constants;
import com.atguigu.likai.utils.VirtualkeyboardHeight;
...
import static com.atguigu.likai.R.id.ll_root;
...
//                CartStorage.getInstance(this).addData(goodsBean);
            ...
            case R.id.tv_more_home:
                ...
                break;
            case R.id.btn_more:
//                Toast.makeText(this, "消失更多主页", Toast.LENGTH_SHORT).show();
                llRoot.setVisibility(View.GONE);
                break;
        }
    }
